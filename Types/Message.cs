...
namespace Telegram.Bot.Types
{
    ...
    public class Message : IUpdate
    {

        public async Task<Message> ReplyText(
            string text, 
            bool replyIt = true, 
        ...
        {
            return await __client.SendTextMessageAsync(
                    Chat.Id, text, parseMode, webPreviwe, notify, replyIt ? MessageId : 0, replyMarkup
                );
        }
